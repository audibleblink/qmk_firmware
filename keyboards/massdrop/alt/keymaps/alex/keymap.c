...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL_T(KC_ESC), KC_A,    KC_S,    KC_D, LT(3, KC_F), KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
        SC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,          KC_UP,   KC_PGDN, \
        MO(2), KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RALT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    // Main Fn/Media/LED layer
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, _______, _______, KC_CAPS,          KC_VOLU, _______, \
    ...
    [2] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, TO(4),   _______, KC_4,     KC_5,      KC_6, _______, _______,          _______, _______, \
